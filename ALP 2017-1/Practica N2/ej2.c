...
int main()
{
	int numeros[7]={45,3,23,67,12,41,8}, ordenados[7], max_local=0, indice_usado=100; /*Nuestras variables
...
/*Para ordenar los números usaremos un ciclo for "anidado" en otro. El for anidado buscará el námero
